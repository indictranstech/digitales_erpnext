...
erpnext.hr.AttendanceControlPanel = frappe.ui.form.Controller.extend({
	...
	get_template:function() {
		...
		window.location.href = repl(frappe.request.url +
			'?cmd=%(cmd)s&from_date=%(from_date)s&to_date=%(to_date)s', {
				cmd: "erpnext.hr.doctype.digitales_upload_attendance.digitales_upload_attendance.get_template",
	...
	show_upload: function() {
		...
		frappe.upload.make({
			parent: $wrapper,
			args: {
				method: 'erpnext.hr.doctype.digitales_upload_attendance.digitales_upload_attendance.upload'
